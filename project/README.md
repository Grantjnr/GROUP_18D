...
- AI inference using Vision Transformer (ViT) model (ResNet option commented out)
...
## Project Authors (Group 18D - UENR)

- **KWAME OFOSU GRANT** (UEB3262522)
- **BOAKYE OBED FORDJOUR** (UEB3258722)
- **BEMAH REGINA** (UEB3263822)
- **ISHAQ DAUDA** (UEB3250822)
- **AWONAYA DERRICK** (UEB3259522)

**Supervised by:** Dr. Kwabena Adu  
